...
namespace SQLDAL
{
    public class BackupAndRestoreDb
    {
        ...
        public void BackDb(string backupPath)
        {
            ...
            string strSql = "backup database AddressList to disk=@backupPath"; //备份命令
        ...
        public void RestoreDb(string restorePath)
        {
            ...
            strSql = strSql + " use master;restore database AddressList from disk=@restorePath with Replace; ";
            strSql = strSql + " Alter database AddressList Set Online with rollback Immediate";
